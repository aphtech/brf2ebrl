...
def tag_inline_tn(text: str, parser_context: ParserContext, *, start: int = 0):
    new_text = ""
...
def tag_symbols_list_tn(text: str, parser_context: ParserContext = ParserContext(), *, cursor: int = 0) -> str:
    new_text = ""
    start = cursor
